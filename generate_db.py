...
def build_enterprise_database():
    ...
    if cursor.fetchone()[0] == 0:
        for i in range(1, 61):
            ...
            # Formatting dates as strings (.isoformat()) to suppress Python 3.12+ warnings safely
            ...
            for month_offset in range(11, -1, -1):
                ...
                # FIXED: Changed to exactly 5 placeholder values to match the 5 target columns
                cursor.execute("""
