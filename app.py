...
st.sidebar.caption(
    "Data note: company, subscription, and usage data are fully synthetic — "
    "engineered with deliberately injected churn-risk profiles to demonstrate "
    "the detection logic (window-function-based usage drop analysis), not to "
...
# ------------------------------------------
# PANEL 3: WRITTEN STRATEGIC REPORT
# ------------------------------------------
elif page == "Written Strategic Report":
    st.title("Strategic Analysis Briefing: ARR Defense & Churn Anomalies")
    st.markdown("*Internal demonstration report — generated live from the synthetic operational database described above.*")
    st.markdown("---")
